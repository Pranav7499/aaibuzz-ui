...
//           <BenefitCard title="Faster Deployments" description="Automated CI/CD pipelines reduce deployment time drastically." />
//           <BenefitCard title="Improved Security" description="Infrastructure-as-code with automated security checks." />
//           <BenefitCard title="Cost Optimization" description="Reduce cloud costs without sacrificing performance." />
//           <BenefitCard title="High Scalability" description="Auto-scaling infrastructure built for growth." />
//           <BenefitCard title="Reliability" description="Multi-region deployments ensure uptime." />
//           <BenefitCard title="Seamless Integration" description="Integrates smoothly with your existing systems." />
//         </div>
//         <CenterButton text="Click here to know more about our Cloud Services" />
//       </Section>

//       {/* QUOTE */}
//       <QuoteBanner quote="AAIBUZZ focuses on real project management, achieving success no matter what." />
...
//         <Grid cols="md:grid-cols-3">
//           <Pricing icon={<FaMoneyBillWave />} title="Fixed Price Model" desc="Best for well-defined projects." />
//           <Pricing icon={<FaProjectDiagram />} title="Dedicated Team Model" desc="Hire a full DevOps team." />
//           <Pricing icon={<FaUsers />} title="Onsite Model" desc="Engineers working at your location." />
//         </Grid>
//       </Section>
...
//           Would you like professional cloud infrastructure? Let’s talk!
//         </p>
...
// const CenterButton = ({ text }) => (
//   <div className="text-center mt-16">
//     <button className="px-8 py-3 border-2 border-blue-600 text-blue-600 font-semibold rounded-md hover:bg-blue-600 hover:text-white transition">
//       {text}
//     </button>
//   </div>
// );

// const SubService = ({ title }) => (
...
//   <div className="flex flex-col items-center bg-blue-600 text-white p-8 rounded-lg">
//     <div className="text-4xl mb-4">{icon}</div>
//     <p className="font-semibold">{title}</p>
//   </div>
// );

// const SplitSection = ({ title, text }) => (
...
const Pricing = ({ icon, title, desc, features }) => (
...
const OrangeBanner = ({ small, highlight, text }) => (
...
const BestPractice = ({ icon, title, description }) => (
